...
jQuery(document).ready(function(){
	...
	jQuery(".addnewmenu_item").on("click", function(){
		...
		//alert(menuid);
		jQuery(this).hide();
		jQuery(this).parent().append("<h3 class='addmenuheading'><i class='fa fa-plus-circle' style='margin-right: 5px;'></i> Add New Menu Item</h3><form action='dashboard.php?p=manage_menu&add=menuitem' method='post' class='form addmenuform' id='adnewmenuitmfrm'><input type='hidden' name='menuid' id='menuid' value='"+menuid+"'><div class='col100 '> <p><input type='checkbox' name='tempmeal' id='tempmeal'> Temporary Meal</p> </div><div class='col50 left twocll'> <p><input type='text' name='menu_name' id='menu_name' placeholder='Name'></p> </div> <div class='col50 right twocll'> <p><input type='text' name='menu_dsc' id='menu_dsc' placeholder='Ingredients'></p> </div> <div class='col50 left twocll'> <p><input type='text' name='menu_price' id='menu_price' placeholder='Price'></p> </div> <div class='col50 right twocll'> <p><input type='text' name='calories' id='calories' placeholder='Calories'></p> </div> <div class='col50 left twocll'> <p><select name='category' id='category'><option >Breakfast</option><option >Lunch</option><option>Dinner</option><option >Breakfast & Lunch</option><option >Breakfast & Dinner</option><option >Lunch & Dinner</option><option >All 3</option></select></p> </div> <div class='col50 right twocll'> <p><select name='type' id='type'><option >Keto</option><option >Halal</option></select></p> </div> <div class='col100 left twocll'> <p><textarea type='text' name='cooking' id='cooking' placeholder='Description'></textarea></p> </div> <div class='col100 left twocll'> <p><input type='number' name='quantity' id='quantity' placeholder='5'></p> </div> <div class='col50 left twocll'> <p>Sunday Opening Time:<input type='time' name='sun_open' id='sun_open' ></p> </div> <div class='col50 right twocll'> <p>Sunday Closing Time:<input type='time' name='sun_close' id='sun_close'></p> </div> <div class='col50 left twocll'> <p>Monday Opening Time:<input type='time' name='mon_open' id='mon_open' ></p> </div> <div class='col50 right twocll'> <p>Monday Closing Time:<input type='time' name='mon_close' id='mon_close'></p> </div> <div class='col50 left twocll'> <p>Tuesday Opening Time:<input type='time' name='tue_open' id='tue_open' ></p> </div> <div class='col50 right twocll'> <p>Tuesday Closing Time:<input type='time' name='tue_close' id='tue_close'></p> </div> <div class='col50 left twocll'> <p>Wednesday Opening Time:<input type='time' name='wed_open' id='wed_open' ></p> </div> <div class='col50 right twocll'> <p>Wednesday Closing Time:<input type='time' name='wed_close' id='wed_close'></p> </div> <div class='col50 left twocll'> <p>Thursday Opening Time:<input type='time' name='thu_open' id='thu_open' ></p> </div> <div class='col50 right twocll'> <p>Thursday Closing Time:<input type='time' name='thu_close' id='thu_close'></p> </div> <div class='col50 left twocll'> <p>Friday Opening Time:<input type='time' name='fri_open' id='fri_open' ></p> </div> <div class='col50 right twocll'> <p>Friday Closing Time:<input type='time' name='fri_close' id='fri_close'></p> </div> <div class='col50 left twocll'> <p>Saturday Opening Time:<input type='time' name='sat_open' id='sat_open' ></p> </div> <div class='col50 right twocll'> <p>Saturday Closing Time:<input type='time' name='sat_close' id='sat_close'></p> <div class='col50 right twocll'> <p><input type='submit' value='Add Menu Item'></p></div> </div> <div class='clear'></div></form>");
	});
	...
	jQuery(".main_menu_item_edit").on("click", function(){
		...
		var category = jQuery(this).attr("data-menu-category");
		var type = jQuery(this).attr("data-menu-type");
		var calories = jQuery(this).attr("data-menu-calories");
		var cooking = jQuery(this).attr("data-menu-cooking");
		var menuoutofstock = jQuery(this).attr("data-out-of-stock");
		var sun_open = jQuery(this).attr("data-sun-opening");
		var sun_close = jQuery(this).attr("data-sun-closing");
		var mon_open = jQuery(this).attr("data-mon-opening");
		var mon_close = jQuery(this).attr("data-mon-closing");
		var tue_open = jQuery(this).attr("data-tue-opening");
		var tue_close = jQuery(this).attr("data-tue-closing");
		var wed_open = jQuery(this).attr("data-wed-opening");
		var wed_close = jQuery(this).attr("data-wed-closing");
		var thu_open = jQuery(this).attr("data-thu-opening");
		var thu_close = jQuery(this).attr("data-thu-closing");
		var fri_open = jQuery(this).attr("data-fri-opening");
		var fri_close = jQuery(this).attr("data-fri-closing");
		var sat_open = jQuery(this).attr("data-sat-opening");
		var sat_close = jQuery(this).attr("data-sat-closing");
		var quantity = jQuery(this).attr("data-quantity");
		
		var tempmeal = jQuery(this).attr("data-tempmeal");
		
		console.log("tempmeal : "+tempmeal);    
        if(tempmeal == "1")
		{
		    var tempmeal = "checked";
		...
		jQuery("#main_menu_item_edit_div_"+menuid).html("<form action='dashboard.php?p=manage_menu&edit=menuitem' method='post' class='form addmenuform' id='adnewmenuitmfrm'><input type='hidden' name='rid' id='rid' value='"+menuid+"'><input type='hidden' name='menuid' id='menuid' value='"+mainmenuidd+"'><div class='col100 centre'> <p ><input type='checkbox' name='tempmeal' id='tempmeal' value='1' "+tempmeal+">Temporary Meal</p> </div><div class='col50 left twocll'> <p><input type='text' name='menu_name' id='menu_name' value='"+menuname+"' required='Name'><label alt='Name' placeholder='Name'></label></p> </div> <div class='col50 right twocll'> <p><input type='text' name='menu_dsc' id='menu_dsc' value='"+menudesc+"' required=''><label alt='Ingrdeients' placeholder='Ingredients'></label></p> </div><div class='col50 left twocll'> <p><input type='text' name='menu_price' value='"+menuprce+"' id='menu_price' required='Price'><label alt='Price' placeholder='Price'></label></p> </div> <div class='col50 right twocll'> <p><input type='text' name='calories' id='calories' value='"+calories+"' required=''><label alt='Calories' placeholder='Calories'></label></p> </div> <div class='col50 left twocll'> <p><select name='category' value='"+category+"' id='category'><option >Breakfast</option><option >Lunch</option><option>Dinner</option><option >Breakfast & Lunch</option><option >Breakfast & Dinner</option><option >Lunch & Dinner</option><option >All 3</option></select><label alt='Category' placeholder='Category'></label></p> </div> <div class='col50 right twocll'> <p><select name='type' value='"+type+"' id='type'><option >Keto</option><option >Halal</option></select><label alt='Type' placeholder='Type'></label></p> </div> <div class='col50 left twocll'> <p>Sunday Opening Time:<input type='time' name='sun_open' id='sun_open' value='"+sun_open+"' ></p> </div> <div class='col50 right twocll'> <p>Sunday Closing Time:<input type='time' name='sun_close' id='sun_close' value='"+sun_close+"'></p> </div> <div class='col50 left twocll'> <p>Monday Opening Time:<input type='time' name='mon_open' id='mon_open' value='"+mon_open+"' ></p> </div> <div class='col50 right twocll'> <p>Monday Closing Time:<input type='time' name='mon_close' id='mon_close' value='"+mon_close+"'></p> </div> <div class='col50 left twocll'> <p>Tuesday Opening Time:<input type='time' name='tue_open' id='tue_open' value='"+tue_open+"' ></p> </div> <div class='col50 right twocll'> <p>Tuesday Closing Time:<input type='time' name='tue_close' id='tue_close' value='"+tue_close+"'></p> </div> <div class='col50 left twocll'> <p>Wednesday Opening Time:<input type='time' name='wed_open' id='wed_open' value='"+wed_open+"' ></p> </div> <div class='col50 right twocll'> <p>Wednesday Closing Time:<input type='time' name='wed_close' id='wed_close' value='"+wed_close+"'></p> </div> <div class='col50 left twocll'> <p>Thursday Opening Time:<input type='time' name='thu_open' id='thu_open' value='"+thu_open+"' ></p> </div> <div class='col50 right twocll'> <p>Thursday Closing Time:<input type='time' name='thu_close' value='"+thu_close+"' id='thu_close'></p> </div> <div class='col50 left twocll'> <p>Friday Opening Time:<input type='time' name='fri_open' id='fri_open' value='"+fri_open+"' ></p> </div> <div class='col50 right twocll'> <p>Friday Closing Time:<input type='time' name='fri_close' id='fri_close' value='"+fri_close+"'></p> </div> <div class='col50 left twocll'> <p>Saturday Opening Time:<input type='time' name='sat_open' id='sat_open' value='"+sat_open+"'></p> </div> <div class='col50 right twocll'> <p>Saturday Closing Time:<input type='time' name='sat_close' id='sat_close' value='"+sat_close+"'></p> </div> <div class='col50 left twocll'> <p>Description:<input type='text' value='"+cooking+"' name='cooking' id='cooking' placeholder='Description'><label alt='Description' placeholder='Description'></label><p style='margin-top: 0px !important'><input type='hidden' name='outofstock' id='require_items' value='1' "+menuoutofstock+" /></p></p> </div> <div class='col50 right twocll'> <p>Quantity:<input type='number' name='quantity' value='"+quantity+"' id='quantity'></p> </div>  <div class='col50 right twocll'> <p><input type='submit' value='Update Menu Item'></p></div> </div><div class='clear'></div></form>");
	});
